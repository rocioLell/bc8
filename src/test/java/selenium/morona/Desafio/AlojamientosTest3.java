...
public class AlojamientosTest3 {
    ...
    public By localizadorMes = By.xpath("//span[@class=\"_dpmg2--month-title-month\"]");
    ...
    //public By localizadorBtnReservaActividad = By.xpath("(//button[@class=\"eva-3-btn -eva-3-fwidth -md -primary\"])[1]");
    ...
    public void alojamientoMasActividad()  {
        ...
        //String meses = driver.findElement(localizadorMes).getText();
        //System.out.println(meses);
        //int cantMeses= meses.size();
        //String mes = String.valueOf(meses);
        //String webElementMes = driver.findElement(localizadorMes).getText();
